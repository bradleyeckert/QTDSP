...
void BiQuad_new(const int type, const smp_type dbGain, const smp_type freq,
		   const smp_type srate, const smp_type bandwidth, biquad* const b)
{
...
void BiQuad_clear(biquad* const b)
{
  /* zero initial samples */
  b->x1 = b->x2 = 0;
  b->y1 = b->y2 = 0;
