...
Standing on the shoulders of giants provides a starting point.
...
In the interest of a lay-friendly nomenclature, we call one dimension of time
...
Quantum time allows for ``randomness'' in a non-deterministic, pantheistic
Universe. In other words, a form of Leibnizian Idealism \cite{Leibniz}.
