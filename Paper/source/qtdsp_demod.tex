...
as seen in Fig. \ref{fig:Uspec}. Lower N generates more noise.

\begin{figure}
	\centering
	\includegraphics[width=0.99\linewidth]{../source/U.png}
	\caption{Power spectrum of U, time-warped test chirp}
	\label{fig:Uspec}
\end{figure}
